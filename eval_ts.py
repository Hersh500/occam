from learned_ctrlr_opt.eval.runner_registry import ts_runners
...
def main(cfg):
    ...
    results = pool.starmap(ts_runners[cfg.robot_name.lower()], args)
    offset = cfg.ts_num_offset
    robot_name = cfg.robot_name
    test_set = cfg.test_set_name
    model_name = "ts_" + cfg.ts_ckpt_dir.split('/')[-2]
