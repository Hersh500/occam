...
def branin_fpacoh_runner(fpacoh_model, experiment_cfg, random_seed):
    ...
    fpacoh_guesses = np.zeros((len(test_params_array), num_trials, 2))
    ...
    for p in range(len(test_params_array)):
        ...
        branin_env = Branin(params_array, kf_cfg.gains_to_optimize)
        ...
        for trial in range(num_trials):
            ...
            # expected_variances[p, trial] = pacoh_std.squeeze()**2  # saving variance, not std
