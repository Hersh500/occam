...
def branin_lkbo_runner(experiment_cfg, random_seed):
    ...
    lkbo_guesses = np.zeros((len(test_params_array), num_trials, 2))
    ...
    for p, params in enumerate(test_params_array):
        ...
        train_x = torch.zeros((num_trials, 2)).float().to(device)
        ...
        for trial in range(num_trials):
            ...
            if trial > experiment_cfg.lkbo_num_explore_iters:
                ...
                var = get_covar_module(2)(input_test)
